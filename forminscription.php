...
<form action="trait.php" method="post" class="formulaire-in">
                ...
                <div class="groupe-in">
                    ...
                    <input type="email" id="input_mail_inscription" name="email" class="input-info-in <?php if(isset($emailMsgErreur) && !empty($emailMsgErreur)) echo 'is-invalid'; ?>" aria-describedby="emailFeedback">
